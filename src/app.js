...
const databaseUrl = `mongodb+srv://${encodeURIComponent(process.env.MONGO_DB_USER)}:${encodeURIComponent(process.env.MONGO_DB_PASSWORD)}@songs.mjkohuw.mongodb.net/?retryWrites=true&w=majority`
